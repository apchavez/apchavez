...
|---|---|---|---|
| [aws-typescript](https://github.com/apchavez/aws-typescript) | Cloud | ❌ 2026-09-11 | Deploy — · Destroy — (💤 costo cero) |
| [azure-python](https://github.com/apchavez/azure-python) | Cloud | ❌ 2026-09-07 | Deploy — · Destroy — (💤 costo cero) |
| [gcp-go](https://github.com/apchavez/gcp-go) | Cloud | ❌ 2026-09-11 | Deploy — · Destroy ✅ 2026-07-29 (💤 costo cero) |
| [quarkus-react](https://github.com/apchavez/quarkus-react) | Fullstack | ❌ 2026-09-10 | — |
| [spring-webflux-angular](https://github.com/apchavez/spring-webflux-angular) | Fullstack | ❌ 2026-09-11 | — |
| [spring-mvc-angular](https://github.com/apchavez/spring-mvc-angular) | Fullstack | ❌ 2026-09-11 | — |
| [net-vue](https://github.com/apchavez/net-vue) | Fullstack | ❌ 2026-09-11 | — |
| [spring-jpa-native](https://github.com/apchavez/spring-jpa-native) | Fullstack | ✅ 2026-09-11 | — |

_Actualizado automáticamente 2026-09-12 10:32 UTC por [update-status.yml](.github/workflows/update-status.yml)._
